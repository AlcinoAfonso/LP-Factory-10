...
| Gestor Estrutural | GE-E20.3-05 | Atualização da Base Técnica era opcional apesar de novo contrato durável. | requer patch estrutural | incorporado | 3.1, 3.2, 3.3 e 3.4 | Cada fase atualiza obrigatoriamente os documentos correspondentes aos contratos que materializa. |
