...
| `MM-08` | LP concreta ≠ identidade | A landing page é a unidade concreta percebida pelo cliente. Identidade é uma classificação/semântica compartilhável: duas ou mais LPs concretas podem possuir a mesma identidade sem serem a mesma LP. | decisão humana aceita | — | — | — | — | pendente |
| `MM-09` | Relação entre identidade e grupo | Ainda não decidido se o agrupamento futuro será derivado da própria identidade, limitando a organização às LPs semanticamente equivalentes, ou se `Grupo` será uma organização opcional criada livremente pelo cliente. Não consolidar essa escolha agora. | questão explicitamente adiada | — | — | — | — | pendente |
...
- O grupo deve ser derivado da identidade ou ser uma organização opcional e livre criada pelo cliente?
