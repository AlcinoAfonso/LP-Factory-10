...
- o arquivo `docs/template-briefing-codex.md` ficar mais simples e direto;
- as proteções essenciais forem mantidas;
- `npm ci` e `npm run check` continuarem explicitamente presentes;
- o template ficar orientado a resultado, não a microprocessos longos;
- nenhum outro arquivo for alterado.
...
Se algum comando falhar, não trate o caso como pronto. Informe o erro no relatório final.
