...
- Resolver a configuração ativa e elegível pelo lifecycle E21, sem fixar nem alterar modelo ou reasoning effort neste recorte. Executar uma Responses API foreground, Structured Output estrito, `store:false`, `background:false`, herdando o timeout compartilhado de 120 segundos e preservando zero retry.
