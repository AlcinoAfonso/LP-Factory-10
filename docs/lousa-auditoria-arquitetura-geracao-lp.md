...
| AUD-12 | Fidelidade à oferta | A ampliação de compra do primeiro imóvel para venda, locação e avaliação foi autorizada por pesquisas e mapas genéricos, apesar da configuração concreta `buy`. | `EV-04`, `EV-05`, `EV-08`, `EV-10` | O PR #725 confirmou visualmente que Hero e fechamento reúnem compra, venda, locação e avaliação no mesmo argumento e CTA. | Confirmado: a observação do PR #725 converge com a reconstrução forense do snapshot e reforça que não se trata apenas de impressão subjetiva sobre a copy. | confirmado |
| AUD-13 | Provas e fatos | Tipos genéricos de prova, como CRECI verificável e contrato por escrito, foram tratados como fatos concretos sem suporte suficiente no contexto exposto. | `EV-04` a `EV-06`, `EV-08`, `EV-10` | O PR #725 registrou que “CRECI verificável” e outras provas aparecem sem número, referência ou prova visível na página. | Confirmado com ajuste: a ausência visual reforça o risco, mas a conclusão factual continua sustentada principalmente pela configuração e pelo snapshot, que não autorizaram todas as afirmações exibidas. | confirmado com ajuste |
| AUD-14 | Validação | Os validadores protegem fortemente forma e integridade, mas não asseguram fidelidade comercial nem sustentação factual das afirmações. | `EV-04` a `EV-06`, `EV-08`, `EV-10` | O PR #725 separou defeitos contratuais, evolução visual e lacunas de evidência e registrou que ainda faltava consolidar provas de widths, foco, overflow, contraste, interações, copy e fidelidade factual. | Confirmado com ajuste: além da lacuna semântica dos validadores automáticos, existia uma lacuna distinta de evidência humana de fechamento. Uma não deve ser usada para mascarar a outra. | confirmado com ajuste |
