...
- **Gestor de Automações:** atua somente quando houver fase marcada como `Automação: sim`.
...
3. Obter uma vez os pareceres Estrutural e de Updates; obter Automações somente quando aplicável.
