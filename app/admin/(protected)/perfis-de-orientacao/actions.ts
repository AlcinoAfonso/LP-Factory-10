...
import { fingerprintGenerationProfileProposal, getGenerationProfileProposalCorrelation, type GenerationProfileDraftInput, type GenerationProfileEditorContent, type GenerationProfileProposal } from "@/conversion-content/landing-page/generation-profile";
...
export async function proposeGenerationProfileAction(input: { taxonId: string; currentEditor: GenerationProfileEditorContent; currentCandidate?: GenerationProfileProposal; humanFeedback?: string }) {
  const gate = await requirePlatformAdmin();
