...
import { readAdminGenerationProfileDetail } from "@/conversion-content/adapters/landingPageGenerationProfileAdminAdapter";
...
export default async function AdminGenerationProfileDetailPage({ params }: { params: Promise<{ taxonId: string }> }) {
  ...
  const resolved = await resolveLandingPageGenerationProfileForTaxon({ taxonId });
