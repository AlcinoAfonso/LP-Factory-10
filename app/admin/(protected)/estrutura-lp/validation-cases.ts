...
assert.match(factualReviewLifecycle, /name="expectedContextFingerprint"/);
...
assert.match(taxonomyActions, /current\.contextFingerprint !== expectedContextFingerprint/);
...
assert.match(lifecycleAdapter, /recordAdminInputCatalogDraftHumanDecision/);
...
assert.doesNotMatch(lifecycleAdapter, /export async function saveAdminInputCatalogDraft\(/);
