...
assert.doesNotMatch(page, /OpenAiLandingPageTextComparison|comparisonActions/);
assert.doesNotMatch(page, /maxDuration = 300/);
assert.match(page, /title="Configuração OpenAI"/);
