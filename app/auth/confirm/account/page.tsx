    ...
    <div className="flex min-h-svh w-full items-center justify-center p-6 md:p-10">
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Conta indisponível</CardTitle>
              <CardDescription>
                Esta conta não está liberada para acesso no momento.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Isso pode acontecer quando a conta está suspensa, cancelada,
                  em revisão ou com status que bloqueia acesso.
                </p>

                <div className="flex flex-col gap-2">
                  <a
                    href="mailto:suporte@lpfactory.com.br?subject=LP%20Factory%20-%20Conta%20Indispon%C3%ADvel"
