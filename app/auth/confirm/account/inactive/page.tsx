    ...
    <div className="flex min-h-svh w-full items-center justify-center p-6 md:p-10">
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Conta inativa</CardTitle>
              <CardDescription>
                Esta conta está temporariamente restrita para acesso.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Isso normalmente acontece por pendência de pagamento. Para
                  reativar, regularize a situação da conta.
                </p>

                <div className="flex flex-col gap-2">
                  <a
                    href="mailto:suporte@lpfactory.com.br?subject=LP%20Factory%20-%20Reativar%20Conta%20(Inativa)"
