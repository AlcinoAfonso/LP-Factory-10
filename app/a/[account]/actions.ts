...
import { renameAndActivate } from 'src/lib/access/adapters/accountAdapter'; // ✅ ajuste
...
export async function renameAccountAction(
  ...
  try {
    ...
    // ✅ chama função nomeada do adapter
    const updated = await renameAndActivate(accountId, name, slug);
