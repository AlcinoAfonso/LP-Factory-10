...
Se investigação, fontes, Updates, implementação, validação ou review demonstrarem que executar a V2 Light exige crescimento estrutural material não previsto, ou que correções sucessivas ampliam a solução em vez de convergir, suspenda somente o ponto afetado e devolva a incompatibilidade ao supervisor competente para simplificação ou reclassificação; não amplie a V2, não acione especialistas diretamente nem transforme o Light em uma Complexa parcial.
