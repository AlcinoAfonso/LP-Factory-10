...
- Não criar segundo PR quando houver handoff da orquestração, salvo o PR corretivo único após merge quando uma validação obrigatória revelar defeito.
