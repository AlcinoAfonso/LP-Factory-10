...
6. Em `updates aplicáveis com patches autossuficientes`, exigir um patch completo para cada update aprovado. Em `requer investigação`, exigir fonte ou evidência faltante e forma de obtê-la. Em `bloqueado por decisão humana`, exigir indicação exata de falta de autoridade no workflow, definição de produto indispensável ausente ou ampliação do escopo aprovado, além da decisão e das opções válidas. Considerar incompleto qualquer bloqueio fundamentado somente em materialidade, existência de mais de uma alternativa técnica ou tecnologia meramente futura.
