...
5. Exigir pareceres do Gestor Estrutural e do Gestor de Updates. Exigir também o parecer do Gestor de Automações quando a v1 contiver `Automação: sim` sem dispensa humana explícita da avaliação formal; com dispensa registrada, exigir `N/A — avaliação formal dispensada na v1`. Em planos anteriores sem esse registro, exigir o parecer.
