...
export * as landingPageGenerationProfile from "./landing-page/generation-profile";
export {
...
export { resolveLandingPageGenerationProfileForTaxon } from "./adapters/landingPageGenerationProfileAdapter";
